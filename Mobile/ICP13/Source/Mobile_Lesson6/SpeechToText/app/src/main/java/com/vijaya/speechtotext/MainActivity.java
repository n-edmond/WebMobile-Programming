...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private void startVoiceInput() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Hello, How may I help you?");
        try {
        ...
        switch (status) {
            case TextToSpeech.SUCCESS: {
                ...
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED)
                    ...
                    mHintView.setText("Tap on mic to start. Try saying Hello!");
                break;
            }
    ...
    private void response(String input) {
        ...
        //One of the three questions. The user can state that they are not feeling good
            ...
            mTts.speak("I understand. Please describe your symptoms", TextToSpeech.QUEUE_FLUSH, null);
        }
        //if the user describes any of these symptoms it will tell them to speak with a professional
            ...
            mTts.speak("You should speak with a medical professional. You may have the flu.", TextToSpeech.QUEUE_FLUSH, null);
        }
        //Once the user has described their symptoms, they may ask for medicine recommendations. IT will give a default statement
            ...
            mTts.speak("I think you might have a fever or flu. You should probably take an acetaminophen.", TextToSpeech.QUEUE_FLUSH, null);
        }
        ...
        //if the user provides any unknown response it will give this default answer. It will give the hint telling what to ask
            ...
            mTts.speak("I'm sorry. I do not recognize that response.", TextToSpeech.QUEUE_FLUSH, null);
            mHintView.setText("This is a medical assistant. You may ask or state the following: \n \"I do not feel well\n\" \"What medication " +
                    "can I take\n\" \"What is the time?\"");
        }
    }
